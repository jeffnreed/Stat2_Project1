...
# Not an outlier but may need to be removed for model
...
# Thoughts on doing other scatterplots???  Or other EDA tools??? VIF?
...
library(leaps)
reg.fwd.Autos=regsubsets(MSRP ~ Year + Engine.HP + Engine.Cylinders + highway.MPG + Popularity,data=Autos,method="forward",nvmax=15)
summary(reg.fwd.Autos)
